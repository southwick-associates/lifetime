...
#' 
#' @inheritParams wsfr
#' @param perpetuity if TRUE, us a perpetuity calculation 
...
# plotting results like revenue effect and break-even prices
# can probably start out with rough plots to populate results
# - start coding up the actual results scripts
# - need to get results for all 3 license types
# - clean up throughout the day

nc_plot_break_even <- function() {
    
}

nc_plot_revenue_effect <- function() {
